...
void main()
{
    ...
    else if (u_Mode == MODE_UPSAMPLE_FIRST)
    {
        ...
        vec3 upsampledTexture = UpsampleTent9(u_Texture, u_LOD + 1.0f, texCoords, 1.0f / bloomTexSize, u_Radius);
    ...
    else if (u_Mode == MODE_UPSAMPLE)
    {
        ...
        vec3 upsampledTexture = UpsampleTent9(u_BloomTexture, u_LOD + 1.0f, texCoords, 1.0f / bloomTexSize, u_Radius);
