...
namespace askygg
{
	...
	VulkanBuffer::VulkanBuffer(
		...
		: m_VulkanDevice{ device }, m_InstanceCount{ instanceCount }, m_InstanceSize{ instanceSize }, m_UsageFlags{ usageFlags }, m_MemoryPropertyFlags{ memoryPropertyFlags }
	{
 ...
 *
	...
	{
		assert(m_AlignmentSize % m_VulkanDevice.PhysicalDeviceProperties.limits.nonCoherentAtomSize == 0 && "Cannot use VulkanBuffer::FlushIndex if alignmentSize isn't a multiple of Device Limits "
																											"nonCoherentAtomSize");
