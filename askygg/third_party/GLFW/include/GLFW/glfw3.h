...
/*! @brief PassFramebuffer bit depth hint.
 *
 *  PassFramebuffer bit depth [hint](@ref GLFW_RED_BITS).
 */
#define GLFW_RED_BITS               0x00021001
/*! @brief PassFramebuffer bit depth hint.
 *
 *  PassFramebuffer bit depth [hint](@ref GLFW_GREEN_BITS).
 */
#define GLFW_GREEN_BITS             0x00021002
/*! @brief PassFramebuffer bit depth hint.
 *
 *  PassFramebuffer bit depth [hint](@ref GLFW_BLUE_BITS).
 */
#define GLFW_BLUE_BITS              0x00021003
/*! @brief PassFramebuffer bit depth hint.
 *
 *  PassFramebuffer bit depth [hint](@ref GLFW_ALPHA_BITS).
 */
#define GLFW_ALPHA_BITS             0x00021004
/*! @brief PassFramebuffer bit depth hint.
 *
 *  PassFramebuffer bit depth [hint](@ref GLFW_DEPTH_BITS).
 */
#define GLFW_DEPTH_BITS             0x00021005
/*! @brief PassFramebuffer bit depth hint.
 *
 *  PassFramebuffer bit depth [hint](@ref GLFW_STENCIL_BITS).
 */
#define GLFW_STENCIL_BITS           0x00021006
/*! @brief PassFramebuffer bit depth hint.
 *
 *  PassFramebuffer bit depth [hint](@ref GLFW_ACCUM_RED_BITS).
 */
#define GLFW_ACCUM_RED_BITS         0x00021007
/*! @brief PassFramebuffer bit depth hint.
 *
 *  PassFramebuffer bit depth [hint](@ref GLFW_ACCUM_GREEN_BITS).
 */
#define GLFW_ACCUM_GREEN_BITS       0x00021008
/*! @brief PassFramebuffer bit depth hint.
 *
 *  PassFramebuffer bit depth [hint](@ref GLFW_ACCUM_BLUE_BITS).
 */
#define GLFW_ACCUM_BLUE_BITS        0x00021009
/*! @brief PassFramebuffer bit depth hint.
 *
 *  PassFramebuffer bit depth [hint](@ref GLFW_ACCUM_ALPHA_BITS).
 */
#define GLFW_ACCUM_ALPHA_BITS       0x0002100A
/*! @brief PassFramebuffer auxiliary buffer hint.
 *
 *  PassFramebuffer auxiliary buffer [hint](@ref GLFW_AUX_BUFFERS).
 */
...
/*! @brief PassFramebuffer MSAA samples hint.
 *
 *  PassFramebuffer MSAA samples [hint](@ref GLFW_SAMPLES).
 */
#define GLFW_SAMPLES                0x0002100D
/*! @brief PassFramebuffer sRGB hint.
 *
 *  PassFramebuffer sRGB [hint](@ref GLFW_SRGB_CAPABLE).
 */
...
/*! @brief PassFramebuffer double buffering hint and attribute.
 *
 *  PassFramebuffer double buffering [hint](@ref GLFW_DOUBLEBUFFER_hint) and
 ...
 *
 *  @remark PassFramebuffer related hints are not window attributes.  See @ref
